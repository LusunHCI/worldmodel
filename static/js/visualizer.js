...
const poloarchartobserver = new IntersectionObserver(entries => {
  entries.forEach(entry => {
    if (entry.isIntersecting && !myChartDrawn) {
      polarChart();
    }
  });
}, { threshold: 0.3 });

poloarchartobserver.observe(document.getElementById('myChart'));
